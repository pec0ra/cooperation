...
Our model was found to converge rapidly to a high ratio of cooperators. This convergence in thousands of iterations was similar to the one of the Success-Driven migration model but was slower to reach its value. It distinguished our model from the Reputation-Based migration model which didn't reach any stable state before tens of thousand of iteration.
